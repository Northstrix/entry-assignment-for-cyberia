...
:root {
  ...
  --desktop-form-input-height: 61px;
...
.mobile-form-group.textarea {
  min-height: calc(
    var(--desktop-form-input-height) * var(--desktop-form-textarea-lines)
  );
}
.mobile-form-input {
  width: 100%;
  height: var(--desktop-form-input-height);
